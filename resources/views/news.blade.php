    ...
    <section class="bg-white py-16">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Article Cards -->
                <x-mary-card class="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <x-mary-card class="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-6">
                        <div class="flex items-center mb-3">
                            <x-mary-badge value="General" color="warning" class="mr-3" />
                ...
                <x-mary-card class="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-6">
                        <div class="flex items-center mb-3">
                            <x-mary-badge value="Achievement" color="yellow" class="mr-3" />
                        ...
                        <x-mary-button link="#" label="Read More" color="yellow" variant="link" size="sm" right-icon="o-arrow-right" class="px-0" />
                    </div>
                </x-mary-card>
                ...
                <x-mary-card class="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-6">
                        <div class="flex items-center mb-3">
                            <x-mary-badge value="Event" color="purple" class="mr-3" />
                        ...
                        <x-mary-button link="#" label="Read More" color="purple" variant="link" size="sm" right-icon="o-arrow-right" class="px-0" />
                    </div>
                </x-mary-card>
                ...
                <x-mary-card class="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-6">
                        <div class="flex items-center mb-3">
                            <x-mary-badge value="Academic" color="indigo" class="mr-3" />
                        ...
                        <x-mary-button link="#" label="Read More" color="indigo" variant="link" size="sm" right-icon="o-arrow-right" class="px-0" />
                    </div>
                </x-mary-card>
            </div>
            ...
            <div class="flex justify-center mt-12">
                <div class="join">
                    <x-mary-button label="Previous" outline class="join-item" />
                    <x-mary-button label="1" color="primary" class="join-item" />
                    <x-mary-button label="2" outline class="join-item" />
                    <x-mary-button label="3" outline class="join-item" />
                    <x-mary-button label="Next" outline class="join-item" />
                </div>
            </div>
        </div>
    </section>
