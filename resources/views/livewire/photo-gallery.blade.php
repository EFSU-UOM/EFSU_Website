...
<section class="bg-base-200 py-8">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex flex-wrap justify-center gap-4">
            <x-mary-button class="rounded-full btn-primary">All</x-mary-button>
            <x-mary-button class="rounded-full btn-neutral">Events</x-mary-button>
            <x-mary-button class="rounded-full btn-neutral">Seminars</x-mary-button>
            <x-mary-button class="rounded-full btn-neutral">Trips</x-mary-button>
            <x-mary-button class="rounded-full btn-neutral">Activities</x-mary-button>
        </div>
    </div>
