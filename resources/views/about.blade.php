<x-layouts.public>
    ...
    <section class="bg-white py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl sm:text-5xl font-bold tracking-tight text-gray-900 mb-6">
                About <span class="text-blue-600">EFSU</span>
            </h1>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-xl shadow-sm">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 mb-4">Our Goals</h2>
                    <p class="text-gray-600">
    ...
    <section class="bg-white py-16">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">Key Initiatives</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">Academic Support</h3>
                    <p class="text-gray-600">
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">Innovation Hub</h3>
                    <p class="text-gray-600">
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">Student Welfare</h3>
                    <p class="text-gray-600">
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">Alumni Network</h3>
                    <p class="text-gray-600">
    ...
    <section class="bg-gray-50 py-16">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
                <div>
                    <h2 class="text-3xl font-bold text-gray-900 mb-6">Our History</h2>
                    <div class="space-y-6">
                        <p class="text-gray-600">
    ...
    <section class="bg-white py-16">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">The Role of Student Union</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-gray-50 p-8 rounded-xl">
                    <h3 class="text-xl font-semibold text-gray-900 mb-4">Student Representation</h3>
                    <ul class="space-y-3 text-gray-600">
                        <li class="flex items-start">
                            <span class="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3"></span>
                ...
                <div class="bg-gray-50 p-8 rounded-xl">
                    <h3 class="text-xl font-semibold text-gray-900 mb-4">Services & Support</h3>
                    <ul class="space-y-3 text-gray-600">
                        <li class="flex items-start">
                            <span class="w-2 h-2 bg-green-600 rounded-full mt-2 mr-3"></span>
                ...
                <div class="bg-gray-50 p-8 rounded-xl">
                    <h3 class="text-xl font-semibold text-gray-900 mb-4">Community Building</h3>
                    <ul class="space-y-3 text-gray-600">
                        <li class="flex items-start">
                            <span class="w-2 h-2 bg-purple-600 rounded-full mt-2 mr-3"></span>
                ...
                <div class="bg-gray-50 p-8 rounded-xl">
                    <h3 class="text-xl font-semibold text-gray-900 mb-4">Innovation & Growth</h3>
                    <ul class="space-y-3 text-gray-600">
                        <li class="flex items-start">
                            <span class="w-2 h-2 bg-orange-600 rounded-full mt-2 mr-3"></span>
