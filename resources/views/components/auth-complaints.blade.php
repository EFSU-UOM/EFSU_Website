<x-layouts.app>
    <div class="container mx-auto px-4 py-8 md:py-12">
        ...
        <div class="bg-base-100 shadow-md rounded-lg p-6 md:p-10 max-w-lg mx-auto transition-colors duration-300">
            <h2 class="text-3xl font-bold text-center mb-6">Submit a Complaint</h2>
            ...
            <form action="{{ route('complaints.store') }}" method="POST" class="space-y-5">
                ...
                <div class="form-control w-full">
                    <label class="label">
                        <span class="label-text font-medium">Complaint</span>
                    </label>
                    <textarea name="complaint_text" rows="5" placeholder="Type your complaint here..."
                        class="textarea textarea-bordered w-full resize-none" required></textarea>
                </div>
