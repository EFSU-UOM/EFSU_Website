    ...
    <section class="bg-gray-50 py-8">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex flex-wrap justify-center gap-4">
                <button class="bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition-colors">All</button>
                <button class="bg-white text-gray-600 px-6 py-2 rounded-full hover:bg-gray-100 transition-colors">Events</button>
                <button class="bg-white text-gray-600 px-6 py-2 rounded-full hover:bg-gray-100 transition-colors">Seminars</button>
                <button class="bg-white text-gray-600 px-6 py-2 rounded-full hover:bg-gray-100 transition-colors">Trips</button>
                <button class="bg-white text-gray-600 px-6 py-2 rounded-full hover:bg-gray-100 transition-colors">Activities</button>
            </div>
        </div>
    </section>
